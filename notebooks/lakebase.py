...
Duplicated from the repo-root lakebase.py so the serverless embedding
ingestion job in this folder doesn't depend on sys.path tricks to reach the
repo root - keep the two in sync if either changes.
"""
